...
<div
  class="modal w-auto fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[#d0d9e7] p-6 shadow-lg rounded-lg z-20"
  style="display: block;">
  <h2 class="text-2xl font-semibold text-gray-800 mb-4">Admin Email Created</h2>
  <hr class="w-full mb-3 border">
  <p class='mb-2 text-sm md:text-base'>This is your New Email Created! (Use this to Access Admin Dashboard.)</p>
  <p class="text-sm md:text-base"><span class="font-bold mr-2">Email:</span><?php echo $_SESSION['new-admin'] ?></p>
