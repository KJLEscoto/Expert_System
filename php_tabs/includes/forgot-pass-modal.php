...
<div
  ...
  <div class="flex justify-between">
    ...
    <form action="index.php" method="post">
      <button type="submit" name="<?php echo isset($_GET['admin-page']) ? 'close-admin-forg' : 'close-forgot'; ?>"
  ...
  <form action="query/forgot-validation.php" method="POST"
    class="sm:w-[200px] md:w-[300px] lg:w-[500px] mx-auto duration-300">
    <div class="duration-300 mb-3">
      <?php 
